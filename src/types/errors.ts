/**
 * @module types/errors
 * Custom error classes for Agent Bouncer.
...
export class PolicyValidationError extends Error {
  readonly code = 'BOUNCER_POLICY_VALIDATION_ERROR' as const;
...
export class PolicyLoadError extends Error {
  readonly code = 'BOUNCER_POLICY_LOAD_ERROR' as const;
...
export class IdentityError extends Error {
  readonly code = 'BOUNCER_IDENTITY_ERROR' as const;
