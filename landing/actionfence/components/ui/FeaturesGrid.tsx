    ...
    <section id="features" className="w-full py-16">
      <SiteContainer className="flex flex-col gap-16">
        <div className="max-w-4xl">
          <h2 className="text-4xl font-medium tracking-tighter leading-tight md:text-5xl">
            Everything you need to govern AI actions. <span className="text-accent/75">Nothing you don&apos;t.</span>
          </h2>
        </div>

        <div className="grid grid-cols-1 border-t border-l border-zinc-800 md:grid-cols-4">
          {features.map((feature, i) => (
            ...
            >
              ...
              <div className="mt-auto flex flex-col gap-3 p-8">
                <h3 className="text-xl font-medium tracking-tight text-white transition-colors duration-300 group-hover:text-accent">
                  {feature.title}
                </h3>
