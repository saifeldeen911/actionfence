...
const DotField = memo(({
  ...
  sparkle = false,
  waveAmplitude = 0,
  gradientFrom = 'rgba(161, 161, 170, 0.4)', // Muted zinc-400 for brutalist look
  gradientTo = 'rgba(82, 82, 91, 0.4)', // Muted zinc-600
  glowColor = '#09090b', // ActionFence background zinc-950
  ...rest
}: DotFieldProps) => {
