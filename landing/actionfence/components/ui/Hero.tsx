      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-12 items-end pointer-events-none">
        ...
        <div className="col-span-1 lg:col-span-8 flex flex-col gap-8 pointer-events-auto">
          <motion.div
            ...
            className="text-sm font-mono tracking-wider uppercase text-zinc-500"
          >
          ...
          >
            ...
            <span className="text-zinc-600">Who&apos;s watching?</span>
          </motion.h1>
        </div>
        ...
        >
          ...
          <div className="p-8 bg-zinc-900/50 border border-zinc-800 text-sm font-mono text-zinc-300">
            <pre>
