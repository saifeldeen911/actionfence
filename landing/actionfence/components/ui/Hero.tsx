...
then: install the package, create a guard-policy.json, and wire up the middleware.`;
  ...
  return (
    <section className="relative flex min-h-dvh w-full flex-col justify-end overflow-hidden pb-24 pt-32">
      ...
      <SiteContainer className="relative z-10">
        <div className="grid grid-cols-1 items-end gap-16 pointer-events-none lg:grid-cols-12 lg:gap-12">
          <div className="col-span-1 flex flex-col gap-8 pointer-events-auto lg:col-span-8">
            <motion.div
            ...
            <motion.h1
              ...
              className="text-5xl font-medium tracking-tighter leading-[0.95] md:text-7xl lg:text-[7rem]"
            >
          ...
          <motion.div
            ...
            className="col-span-1 flex flex-col gap-8 pointer-events-auto lg:col-span-4"
          >
            ...
            <div className="border border-zinc-800 bg-[#09090b]">
              <div className="flex items-center justify-between gap-4 border-b border-zinc-800 scrollbar-hide">
                ...
                <Link
                  href="/docs/readme"
                  className="shrink-0 px-4 font-mono text-xs uppercase tracking-[0.2em] text-accent/80 transition-colors hover:text-accent outline-none focus-visible:ring-1 focus-visible:ring-accent/60 md:px-6"
                >
                  README
                </Link>
              </div>
              ...
              <div
                ...
                tabIndex={0}
                className="p-5 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-accent/60 md:p-6"
              >
                <AnimatePresence mode="wait">
                  ...
                  >
                    <p className="max-w-xl font-sans text-sm leading-relaxed text-zinc-400 md:text-base">
                      {panelText}
                    </p>
